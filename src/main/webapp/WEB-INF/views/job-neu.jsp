...
<html>
  ...
  <div class="form-group">
    ...
    <div class="col-md-9">
      <input id="bezeichnung" type="text" class="form-control" value="" required />
    </div>
  </div>
  <div class="form-group">
...
<select name="DOBYear">
  ...
  <div class="col-md-9">
    <input id="uhrzeit" type="text" value="" required />
      </div>
    </div>
    <div class="form-group">
		<label for="entlohnung" class="col-md-3 control-label"> Lohn <font color="red">*</font>: </label>
		<div class="col-md-9">
      <input id="entlohnung" type="text" value="" required /> €
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
		...
		<label for="zeitaufwand" class="col-md-3 control-label">Zeitaufwand<font color="red">*</font>: </label>
    		<div class="col-md-9">
      			<input id="zeitaufwand" type="text" value="" required>
  			</div>
    	</div>
    <div class="form-group">
